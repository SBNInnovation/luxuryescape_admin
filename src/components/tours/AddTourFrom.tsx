...
//     formData.append("title", title) // tourName
//     formData.append("price", price.toString()) // cost
//     formData.append("country", country) //✅
//     formData.append("location", location) //✅
//     formData.append("language", language) //(not in schema)
//     formData.append("suitableAge", suitableAge.toString()) //(not in schema)
//     formData.append("maxAltitude", maxAltitude.toString()) //(not in schema)
//     if (thumbnail) {
//       formData.append("thumbnail", thumbnail) //✅
//     }
//     formData.append("mealType", mealType) //(not in schema)
//     formData.append("selectedSeasons", JSON.stringify(selectedSeasons)) //(not in schema)
//     formData.append("minDays", minDays.toString()) // (not in schema)
//     formData.append("maxDays", maxDays.toString()) // (not in schema)
//     formData.append("minGroupSize", minGroupSize.toString()) // (not in schema)
//     formData.append("maxGroupSize", maxGroupSize.toString()) //(not in schema)
//     formData.append("arrivalLocation", arrivalLocation) //(not in schema)
//     formData.append("departureLocation", departureLocation) //(not in schema)
//     formData.append("startingLocation", startingLocation) //(not in schema)
//     formData.append("endingLocation", endingLocation) //(not in schema)
